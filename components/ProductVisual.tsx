        ...
        <>
          ...
          <div className="relative z-10 flex h-full w-full items-center justify-center p-2">
            <Image
              ...
              className={`h-full w-full max-w-full object-contain drop-shadow-[0_10px_24px_rgba(15,23,42,0.18)] brightness-110 contrast-125 saturate-110 transition-opacity duration-700 ease-in-out ${isLoaded ? 'opacity-100' : 'opacity-0'}`}
              unoptimized
              priority={large}
            />
          </div>
